      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <View style={styles.blueContainer}>
          <Svg
            width={width - 40}
            height="137"
            viewBox={`0 0 ${width - 40} 137`}
            fill="none"
            style={styles.blueSvg}
          >
            <Defs>
              <LinearGradient
                id="paint0_linear_177_1042"
                x1="315"
                y1="137"
                x2="-94.3845"
                y2="64.1624"
            ...
            <Rect
              ...
              height="137"
              rx="22"
              fill="url(#paint0_linear_177_1042)"
            />
          </Svg>
          <Image
            source={require("../../assets/images/unireminder.png")}
            style={styles.uniReminderImage}
            resizeMode="contain"
          />
          <View style={styles.uniReminderTextContainer}>
            <Text style={styles.uniReminderTextHeader}>Message from NYU:</Text>
            <Text style={styles.uniReminderText}>
              Dining Hall Closures 6/18
            </Text>
            <TouchableOpacity style={styles.learnMoreButton}>
              <Svg width="95" height="35" viewBox="0 0 95 35" fill="none">
                <Rect
                  ...
                  height="35"
                  rx="17.5"
                  fill="url(#paint0_linear_177_1221)"
                />
                <Defs>
                  <LinearGradient
                    id="paint0_linear_177_1221"
                    x1="95"
                    y1="35"
                    x2="-26.9919"
                    y2="9.37755"
        ...
        <View style={styles.section}>
          <Text style={styles.sectionHeader}>Latest Deals near you</Text>
          <TouchableOpacity
            onPress={() => router.navigate("./Discounts")}
        ...
        <View style={styles.cardsContainer}>
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.cardSubtitle}>21st ST SE</Text>
            <Text style={styles.cardDescription}>
              Free Delivery 6/18 through 6/20
            </Text>
          </View>
          <View style={styles.card}>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionHeader}>Dining Hall Menu</Text>
          <TouchableOpacity
            onPress={() => router.navigate("./DiningHallMenu")}
            style={styles.seeMoreButton}
          >
            <Text style={styles.seeMoreText}>See more</Text>
          </TouchableOpacity>
        ...
        <ScrollView horizontal={true} style={styles.horizontalScroll}>
          <TouchableOpacity
            onPress={() => Linking.openURL("https://dineoncampus.com/NYUeats")}
          >
            <Image
