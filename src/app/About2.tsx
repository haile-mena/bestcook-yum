  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.shapeContainer}>
        ...
        <Image source={require('../../assets/images/about2.png')} style={styles.image} />
      </View>
      <View style={styles.content}>
        <Text style={styles.title}>Dining plans made simple</Text>
        <Text style={styles.description}>
          Track and manage your swipes, stay updated on campus dining options and closures, donate unused swipes and connected with peers.
        </Text>
      </View>
      <Animated.View style={[styles.buttonContainer, { opacity: fadeAnim }]}>
        <TouchableOpacity onPress={handlePress}>
          <Image source={require('../../assets/images/about2button.png')} style={styles.buttonImage} />
        </TouchableOpacity>
      </Animated.View>
    </SafeAreaView>
  );
